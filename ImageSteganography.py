...
def encodeMessage(image, msg):
    ...
    pixels[row-1, column-1] = tuple(newPixel)
    image.save("./test.png")
    with open("test.png","rb") as imgFile:
...
def encode_image(text):
    ...
    imageStr = encodeMessage(image, text)
    print("hello")
    return imageStr

def decode_image(image):
    image = image.encode('utf-8')
    with open("recvfile.png", "wb") as t:
        t.write(base64.b64decode(image))
    return decodeMessage(Image.open("./recvfile.png"))
...
if __name__== "__main__":
    ...
    test = encode_image("test").decode('utf-8')
    decode_image(test)
    # print(test)
    # with open("saveTest.png", "wb") as saveImage:
    #     saveImage.write(base64.b64decode(test.encode('utf-8')))
    # print(decodeMessage(Image.open("./saveTest.png")))
